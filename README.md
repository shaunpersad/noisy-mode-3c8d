...
```
npm create cloudflare@latest -- --template=cloudflare/templates/noisy-mode-3c8d
```

A live public deployment of this template is available at [https://noisy-mode-3c8d.templates.workers.dev](https://noisy-mode-3c8d.templates.workers.dev)
